    ...
    <div class="container">
        ...
        ?>
                <div class="certificate">
                    <?php if (pathinfo($certificate['Image_url'], PATHINFO_EXTENSION) === 'pdf') : ?>
                        <embed class="certificate_view" src="uploads/<?= $certificate['Image_url'] ?>" >
                    <?php else : ?>
                    ...
                    <form method="post" action="stud_img_delet.php">
                        <input  name="Image_url" type="hidden" value="<?php echo $certificate['Image_url']; ?>" >

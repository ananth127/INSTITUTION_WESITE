...
<body>
    ...
    <div class="container">
        ...
        <div class="sidebar" style="overflow-y: auto;">
            ...
            <?php
            $stmt = $con->prepare("select * from `staffdata` WHERE USERNAME=?");
            ...
            ?>
            <a class="stud_rollno" href="stud_message.php?staff_id=<?php echo $class; ?>" target="content-frame">Send Message..</a>
                ...
                ?>
                        <li>
                         <!-- Embedding PHP code inside JavaScript function call -->
                            <a class="stud_rollno" href="#" onclick="loadContent('content2.php', {stud_id: '<?php  echo $row['Roll No'];?>', pass: 'your_password'})"><?php echo $row['Roll No']; ?></a>
                        </li>
                <?php
                    }
                }
